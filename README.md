...
Once the `conda-forge` channel has been enabled, `zig, zig-compiler, zig_impl_linux-aarch64, zig_impl_linux-ppc64le, zig_impl_osx-64, zig_impl_osx-arm64, zig_impl_win-64, zig_linux-64, zig_linux-aarch64, zig_linux-ppc64le, zig_linux-riscv64, zig_osx-64, zig_osx-arm64, zig_win-64` can be installed with `conda`:

```
conda install zig zig-compiler zig_impl_linux-aarch64 zig_impl_linux-ppc64le zig_impl_osx-64 zig_impl_osx-arm64 zig_impl_win-64 zig_linux-64 zig_linux-aarch64 zig_linux-ppc64le zig_linux-riscv64 zig_osx-64 zig_osx-arm64 zig_win-64
```

or with `mamba`:

```
mamba install zig zig-compiler zig_impl_linux-aarch64 zig_impl_linux-ppc64le zig_impl_osx-64 zig_impl_osx-arm64 zig_impl_win-64 zig_linux-64 zig_linux-aarch64 zig_linux-ppc64le zig_linux-riscv64 zig_osx-64 zig_osx-arm64 zig_win-64
```
