...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/zig-feedstock/blob/master/LICENSE.txt)

Summary: Zig is a general-purpose programming language and toolchain for maintaining robust, optimal, and reusable software.

Development: https://github.com/ziglang/zig

Documentation: https://ziglang.org/documentation/0.9.1/
...
<table>
  ...
  <tr>
    ...
    <td>
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15017&branchName=master">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/zig-feedstock?branchName=master">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15017&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/zig-feedstock?branchName=master&jobName=linux&configuration=linux_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Once the `conda-forge` channel has been enabled, `zig` can be installed with:

```
conda install zig
```

It is possible to list all of the versions of `zig` available on your platform with:
