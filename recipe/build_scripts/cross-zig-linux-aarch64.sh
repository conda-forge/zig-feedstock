...
patchelf --replace-needed librt.so.1 "${BUILD_PREFIX}/${_BUILD_SYSROOT_ARCH}-conda-linux-gnu/sysroot/usr/lib64/librt.so" "${BUILD_PREFIX}/bin/zig"
patchelf --replace-needed libdl.so.2 "${BUILD_PREFIX}/${_BUILD_SYSROOT_ARCH}-conda-linux-gnu/sysroot/usr/lib64/libdl.so" "${BUILD_PREFIX}/bin/zig"
patchelf --replace-needed libm.so.6 "${BUILD_PREFIX}/${_BUILD_SYSROOT_ARCH}-conda-linux-gnu/sysroot/usr/lib64/libm.so" "${BUILD_PREFIX}/bin/zig"
