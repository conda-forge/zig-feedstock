#!/usr/bin/env bash
# Cross-compiler build for osx-arm64
# Binary RUNS on linux-64, TARGETS osx-arm64
...
# Standard Linux native-like build (runs on linux-64)
