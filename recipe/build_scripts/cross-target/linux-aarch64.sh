#!/usr/bin/env bash
# Cross-target build for linux-aarch64 using zig as C/C++ compiler
# Binary RUNS on linux-aarch64 (cross-compiled from linux-64)
...
echo "=== Cross-target: linux-64 -> linux-aarch64 using zig cc ==="
