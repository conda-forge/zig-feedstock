#!/usr/bin/env bash
# Cross-compiler build for linux-s390x using zig as C/C++ compiler
# Binary RUNS on linux-64, TARGETS linux-s390x
...
echo "=== Cross-compiler: linux-64 -> linux-s390x using zig cc ==="
