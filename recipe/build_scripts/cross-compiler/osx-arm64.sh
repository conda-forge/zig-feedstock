#!/usr/bin/env bash
# Cross-compiler build for osx-arm64 using zig as C/C++ compiler
...
echo "=== Cross-compiler: linux-64 -> osx-arm64 using zig cc ==="
...
# Only maxrss patch needed (building on Linux)
CMAKE_PATCHES+=(
