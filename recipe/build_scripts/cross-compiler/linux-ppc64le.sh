#!/usr/bin/env bash
# Cross-compiler ENVIRONMENT SETUP for linux-ppc64le
# Native zig (linux-64) configured to TARGET linux-ppc64le
...
echo "=== Cross-compiler Environment: linux-64 -> linux-ppc64le ==="
